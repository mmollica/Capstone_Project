...
if(Input::exists())
{
    ...
    $validation = $validate->check($_POST, array(
      'classid' => array('required' => true),
      'studentid' => array('required' => true)    
    ));
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9" style="height:850px">
          <div class="login" >
            <h1 style="margin-top:-60px;">Assign Student</h1>
			...
			<!--error message-->
			<span class="selectRequiredMsg">Please select a class.</span></span>  
			...
			<!--error message-->
			<span class="selectRequiredMsg">Please select a student.</span></span>  
