...
?>
  <head>
    ...
    <!-- Le styles -->
    <link href="bootstrap.css" rel="stylesheet">   <link href="faith.css" rel="stylesheet"> <style type="text/css">
      body {
        padding-top: 60px;
        padding-bottom: 40px;
      }
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        <div class="span3">
          ...
          <ul class="nav nav-list">
             <li class="nav-header">Users</li>
              ...
              <li class="active"><a href="editlink.php">Edit</a></li>
        ...
        <div class="span9" style="height:850px">
          <div class="login" >
            <h1 style="margin-top:-60px; margin-left:215px;">Edit Link</h1>
            <br>
            
		<form id="createlink" action="processlink.php" method="post" style="margin-left:215px;">
        
        	
            <label for="Link ID">Link ID:</label>
            <select name="linkid" id="Link ID">
             <?php $con = mysqli_connect("localhost","mmollica","Thepw164", "capstone_db"); ?> 
					<?php $result = mysqli_query($con,'SELECT * FROM link ORDER BY linkname ASC'); ?> 
					<?php while($row = mysqli_fetch_assoc($result)) { ?> 
					<option value="<?php echo $row['id'];?>"> 
					<?php echo htmlspecialchars($row['id']) . " - " . htmlspecialchars($row['linkname']); ?> 
					</option> 
					<?php } ?>
