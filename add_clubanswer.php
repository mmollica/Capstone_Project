...
// Insert answer 
$sql2="INSERT INTO clubforum_answer (question_id, a_name, a_title, a_answer, a_datetime) VALUES('{$id}', '{$a_name}', '{$a_title}', '{$a_answer}', '{$datetime}')";
...
echo '<form id="viewtopic" name="form1" method="get" action="view_clubtopic.php">';
